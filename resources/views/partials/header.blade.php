        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col sm:flex-row justify-between items-center text-sm">
                <div class="flex flex-wrap justify-center sm:justify-start gap-4 mb-2 sm:mb-0">
                    <a href="tel:+6585445560" class="hover:text-primary-200 transition-colors flex items-center gap-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                        </svg>
                        +65 8544 5560
                    </a>
                    <a href="mailto:rollershutter14@gmail.com" class="hover:text-primary-200 transition-colors flex items-center gap-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('home') }}" class="flex items-center space-x-2">
                ...
                <div class="hidden md:block">
                    <div class="font-bold text-primary-900 text-lg leading-tight">Roller Shutter & Construction</div>
