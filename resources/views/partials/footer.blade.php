        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    ...
                    <li>
                        <a href="tel:+6585445560" class="flex items-center hover:text-primary-400 transition-colors">
                    ...
                    <li>
                        <a href="mailto:rollershutter14@gmail.com" class="flex items-center hover:text-primary-400 transition-colors break-all">
                            <svg class="w-5 h-5 mr-3 text-primary-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
